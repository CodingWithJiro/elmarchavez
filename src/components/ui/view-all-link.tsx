...
const ViewAllLink = ({ href }: ViewAllLinkProps) => {
  return (
    <Link
      className="group focus-visible:outline-muted-foreground flex items-center gap-1 rounded-sm text-[1rem] font-normal outline-2 outline-offset-4 outline-transparent transition-all duration-150 ease-in-out"
      href={href}
    >
